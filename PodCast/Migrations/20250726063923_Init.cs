    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpeakerProfessions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpeakerProfessions_Professions_ProfessionId",
                        column: x => x.ProfessionId,
                        principalTable: "Professions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SpeakerProfessions_Speakers_SpeakerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpeakerProfessions_ProfessionId",
                table: "SpeakerProfessions",
                column: "ProfessionId");

            migrationBuilder.CreateIndex(
                name: "IX_SpeakerProfessions_SpeakerId",
                table: "SpeakerProfessions",
                column: "SpeakerId");
        }
